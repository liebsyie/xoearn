        ...
        <form onSubmit={handleAuth} className="space-y-5">
              ...
              >
                <div className="relative group">
                  ...
                  <input
                    ...
                    className="w-full bg-white/[0.02] border-2 border-emerald-500/40 ring-2 ring-emerald-500/20 text-black placeholder:text-zinc-400 placeholder:font-medium pl-14 pr-5 py-4 rounded-2xl focus:outline-none focus:ring-4 focus:ring-emerald-500/60 focus:border-emerald-500/70 focus:bg-white/[0.04] transition-all"
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="relative group">
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className="w-full bg-white/[0.02] border-2 border-emerald-500/40 ring-2 ring-emerald-500/20 text-black pl-14 pr-5 py-4 rounded-2xl focus:outline-none focus:ring-4 focus:ring-emerald-500/60 focus:border-emerald-500/70 focus:bg-white/[0.04] transition-all text-sm"
                      required={mode === 'register'}
                    />
                  </div>
                  <div className="relative group">
          ...
          <div className="relative group">
            ...
            <input
              ...
              onChange={handleChange}
              className="w-full bg-white/[0.02] border-2 border-emerald-500/40 ring-2 ring-emerald-500/20 text-black placeholder:text-zinc-400 placeholder:font-medium pl-14 pr-14 py-4 rounded-2xl focus:outline-none focus:ring-4 focus:ring-emerald-500/60 focus:border-emerald-500/70 focus:bg-white/[0.04] transition-all"
              required
            />
            <button
              type="button"
        ...
        <form onSubmit={handleAuth} className="space-y-5">
              ...
              >
                <div className="relative group">
                  ...
                  <input
                    ...
                    value={formData.fullName}
                    onChange={handleChange}
                    className="w-full bg-white/[0.02] border border-white/5 text-white pl-14 pr-5 py-4 rounded-2xl focus:outline-none focus:ring-2 focus:ring-emerald-500/30 focus:bg-white/[0.04] transition-all"
                    required={mode === 'register'}
                  />
                </div>
                <div className="relative group">
          ...
          <div className="relative group">
            ...
            <input
              ...
              value={formData.password}
              onChange={handleChange}
              className="w-full bg-white/[0.02] border border-white/5 text-white pl-14 pr-14 py-4 rounded-2xl focus:outline-none focus:ring-2 focus:ring-emerald-500/30 focus:bg-white/[0.04] transition-all"
              required
            />
            <button
              type="button"
